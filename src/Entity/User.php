...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?string $commissionRate = '2.00';

    #[ORM\Column(type: 'decimal', precision: 10, scale: 2, nullable: true)]
    private ?string $commissionMin = '300.00';
    ...
    public function getCommissionMin(): ?string
    {
        return $this->commissionMin;
    }

    public function setCommissionMin(?string $commissionMin): static
    {
